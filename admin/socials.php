...
<table>
  ...
  <?php while( $record = mysqli_fetch_assoc( $result ) ): ?>
    <tr>
      <td align="center">
        <img src="image.php?type=socials&id=<?php echo $record['id']; ?>&width=300&height=300&format=inside">
      </td>
      ...
      <td align="center">
        <a href="socials.php?delete=<?php echo $record['id']; ?>" onclick="javascript:confirm('Are you sure you want to delete this social?');">Delete</i></a>
      </td>
    </tr>
  <?php endwhile; ?>
</table>

<p><a href="socials_add.php"><i class="fas fa-plus-square"></i> Add Social</a></p>
